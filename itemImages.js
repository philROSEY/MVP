var itemConst = {
    ...
    "voodoo_mask": {
        "hint": [
            "Passive: Spell Lifesteal12% of spell damage dealt to enemy heroes is returned to the caster as health, regardless of spell damage type.  Lifesteal reduced to 2.5% against creeps."
        ],
        "id": 473,
    ...
    "recipe_magic_wand": {
        "id": 35,
        "img": "/apps/dota2/images/items/recipe_lg.png?t=1597682496438",
    ...
    "travel_boots_2": {
        "hint": [
            "Upgrade: Town Portal ScrollUpgrades your Town Portal Scroll, allowing it to target units and heroes, reduces cooldown and does not consume a charge on usage. ",
            "Movement speed bonuses from multiple pairs of boots do not stack."
        ],
        "id": 220,
    ...
    "mekansm": {
        "hint": [
            ...
            "Passive: Mekansm AuraGrants 2 health regeneration and 3 armor to allied units in a 1200 radius."
        ],
        "id": 79,
    ...
    "vladmir": {
        "hint": [
            "Passive: Vladmir's AuraGrants 15% lifesteal, 18% bonus damage, and 2 mana regeneration to nearby allies. Radius: 1200"
        ],
        "id": 81,
    ...
    "holy_locket": {
        "hint": [
            "Active: Energy ChargeTarget an allied unit to instantly restore 15 health and mana per charge stored. Max 20 charges. Gains a charge whenever a visible enemy within 1200 range uses an ability.  ",
            "",
    ...
    "heart": {
        "hint": [
            "Passive: Regeneration AmplificationIncreases all passive health regeneration by 50%. If damage is taken from an enemy hero or Roshan, this amplification is disabled for 5 seconds for melee heroes, or 7 seconds for ranged heroes."
        ],
        "id": 114,
    ...
    "bloodstone": {
        "hint": [
            "Active: Bloodpact Converts 30% of your max mana to health regeneration over 2 seconds.",
            " Passive: Mana BatteryEach charge provides 0.2 MP regen and 0.35% Spell Amp. Nearby kills provide 1 charges. Dying causes you to lose 3 charges. Starts with 14 charges."
        ],
        "id": 121,
        ...
        "attrib": [
            ...
            },
            {
                ...
                "header": "+Spell Lifesteal Amplification",
                "value": "30%"
            }
        ],
        "mc": false,
    ...
    "combo_breaker": {
        "id": 276,
        "img": "/apps/dota2/images/items/combo_breaker_lg.png?t=1593393829403",
        "cost": null,
        "notes": "",
        "attrib": [],
        "mc": false,
    ...
    "crimson_guard": {
        "hint": [
            "Active: Guard For 12 seconds, grant nearby allied heroes and buildings a 100% chance to block 60 damage from each incoming attack.Units may only be affected by Guard once every 40 seconds.Radius: 1200",
            "Passive: Damage Block Grants a 50% chance to block 70 damage from incoming attacks on melee heroes, and 35 damage on ranged."
        ],
        "id": 242,
    ...
    "satanic": {
        "hint": [
            "Active: Unholy RageIncreases Lifesteal percentage to 200% for 5 seconds. ",
    ...
    "skadi": {
        "hint": [
            "Passive: Cold Attack Attacks lower enemy movement and attack speed and reduces heals, health regeneration, lifesteal and spell lifesteal by 40% for 3 seconds. Slows enemy ranged units by -50% movement speed and by -50 attack speed. Slows enemy melee units by -25% movement speed and by -25 attack speed. "
        ],
        "id": 160,
    ...
    "helm_of_the_dominator": {
        "hint": [
            "Active: DominateTakes control of one neutral, non-ancient target unit and sets its movement speed to 425 and max health to a minimum of 1500. Also provides the unit with +25 base attack damage, +12 health regen and +4 mana regenDominated units with a max health of greater than 1500 retain their original max health.  Dominated unit's bounty is set to 200 gold.Range: 700"
        ],
        "id": 164,
    ...
    "arcane_boots": {
        "hint": [
            "Active: Replenish ManaRestores 160 mana to all nearby allies.Radius: 1200",
            "Movement speed bonuses from multiple pairs of boots do not stack."
        ],
        "id": 180,
    ...
    "octarine_core": {
        "hint": [
            "Passive: Cooldown ReductionReduces the cooldown time of all spells and items by 25%.",
    ...
    "ancient_janggo": {
        "hint": [
            "Active: Endurance Gives +45 attack speed and +13% movement speed to nearby allies for 6 seconds. Radius: 1200 "
        ],
        "id": 185,
    ...
    "veil_of_discord": {
        "hint": [
            "Active: Magic Weakness Cast a 600 radius blast that causes enemies to take 18% increased damage from spells.Range: 1000Duration: 16 seconds. ",
            "",
    ...
    "guardian_greaves": {
        "hint": [
            ...
            "Passive: Guardian Aura Grants 2.5 health regeneration and 3 armor to allied units. If an allied hero's health falls below 20%, they receive 16 health regeneration and 10 armor. Radius: 1200 ",
            "Movement speed bonuses from multiple pairs of boots do not stack."
        ],
        "id": 231,
    ...
    "force_boots": {
        "hint": [
            "Active: ForceDispels the user and pushes them 600 units in the direction they are facing.",
    ...
    "flicker": {
        "hint": [
            "Active: Flicker Dispells debuffs and blinks you to a random spot within 400 range. Does not get disabled on incoming damage."
        ],
        "id": 335,
    ...
    "havoc_hammer": {
        "hint": [
            "Active: Havoc Knocks back enemies in 400 range around you, slowing them by 50% for 3 seconds and dealing 275 + 1x your str as magical damage."
        ],
        "id": 364,
    ...
    "panic_button": {
        "hint": [
            "Passive: Rejuvenate  When the wearer's health falls below 20%, they will receive a hard dispel and be healed for 400 health."
        ],
        "id": 365,
...
for (var key in itemConst) {
    itemImgs[itemConst[key].id] = 'https://api.opendota.com'+itemConst[key].img
}
